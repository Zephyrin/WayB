Feature: Login an user using english language
  ...
  Background:
    ...
    Scenario: I will login as user
      Given the request body is:
        ...
        """
      When I request "/api/en/auth/login_check" using HTTP POST
    ...
    Scenario: I will not login as user with a wrong password and I get error message
      Given the request body is:
        """
        {
          "username": "user",
