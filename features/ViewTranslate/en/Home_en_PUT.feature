Feature: Test Home JSON API endpoint PUT
 
    Background:
        Given there are default users

    Scenario: I can create and udpate an home page if I am connected as merchant using PUT
        ...
        """
        When I request "/api/en/home" using HTTP PUT
    ...
    Scenario: I cannot udpate an home page with empty json if I am connected as merchant using PUT
        Given I am login as merchant
        Then the request body is:
        """
        {
    ...
    Scenario: I cannot udpate an home page with wrong value if I am connected as merchant using PUT
        Given I am login as merchant
        Then the request body is:
        """
        {
    ...
    Scenario: I cannot udpate an home page if I am connected as user using PUT
        Given I am login as merchant
        Then the request body is:
        """
        {
