 ...
 */
final class Version20200425114347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE extra_field_def (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sub_category_id INTEGER NOT NULL, link_to_id INTEGER DEFAULT NULL, type VARCHAR(20) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, is_price BOOLEAN NOT NULL, is_weight BOOLEAN NOT NULL, CONSTRAINT FK_5E19D16FF7BFE87C FOREIGN KEY (sub_category_id) REFERENCES sub_category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5E19D16F9F8E16BB FOREIGN KEY (link_to_id) REFERENCES extra_field_def (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
