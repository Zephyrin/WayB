 ...
 */
final class Version20200501155107 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE characteristic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipment_id INTEGER NOT NULL, gender VARCHAR(6) NOT NULL COLLATE BINARY, size VARCHAR(25) NOT NULL COLLATE BINARY, price INTEGER NOT NULL, weight INTEGER NOT NULL, CONSTRAINT FK_522FA950517FE9FE FOREIGN KEY (equipment_id) REFERENCES equipment (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
