 ...
 */
final class Version20200506185042 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brand AS SELECT id, created_by, name, validate, uri FROM brand');
        $this->addSql('DROP TABLE brand');
        $this->addSql('CREATE TABLE brand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, uri VARCHAR(255) NOT NULL COLLATE BINARY, validate BOOLEAN DEFAULT \'0\' NOT NULL, ask_validate BOOLEAN DEFAULT \'0\' NOT NULL, CONSTRAINT FK_1C52F958DE12AB56 FOREIGN KEY (created_by) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO brand (id, created_by, name, validate, uri) SELECT id, created_by, name, validate, uri FROM __temp__brand');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_1C52F958841CB121');
        $this->addSql('DROP INDEX IDX_1C52F958DE12AB56');
        $this->addSql('CREATE TEMPORARY TABLE __temp__brand AS SELECT id, created_by, name, uri, validate FROM brand');
        $this->addSql('DROP TABLE brand');
        $this->addSql('CREATE TABLE brand (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, uri VARCHAR(255) NOT NULL, validate BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO brand (id, created_by, name, uri, validate) SELECT id, created_by, name, uri, validate FROM __temp__brand');
        $this->addSql('DROP TABLE __temp__brand');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1C52F9585E237E06 ON brand (name)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1C52F958841CB121 ON brand (uri)');
        $this->addSql('CREATE INDEX IDX_1C52F958DE12AB56 ON brand (created_by)');
