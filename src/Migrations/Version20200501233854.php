 ...
 */
final class Version20200501233854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__characteristic AS SELECT id, equipment_id, gender, size, weight, price FROM characteristic');
        $this->addSql('DROP TABLE characteristic');
        $this->addSql('CREATE TABLE characteristic (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipment_id INTEGER NOT NULL, gender VARCHAR(6) NOT NULL COLLATE BINARY, size VARCHAR(25) NOT NULL COLLATE BINARY, weight INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, CONSTRAINT FK_522FA950517FE9FE FOREIGN KEY (equipment_id) REFERENCES equipment (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO characteristic (id, equipment_id, gender, size, weight, price) SELECT id, equipment_id, gender, size, weight, price FROM __temp__characteristic');
