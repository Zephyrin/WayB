 ...
 */
final class Version20200525221326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wuser ADD COLUMN last_login DATETIME DEFAULT NULL');
        ...
        $this->addSql('CREATE TABLE backpack (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C358569DE12AB56 FOREIGN KEY (created_by) REFERENCES wuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, validate BOOLEAN DEFAULT \'0\' NOT NULL, ask_validate BOOLEAN DEFAULT \'0\' NOT NULL, CONSTRAINT FK_64C19C1DE12AB56 FOREIGN KEY (created_by) REFERENCES wuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_BCE3F79812469DE2 ON sub_category (category_id)');
        $this->addSql('CREATE INDEX IDX_BCE3F798DE12AB56 ON sub_category (created_by)');
        $this->addSql('DROP INDEX UNIQ_2107C297F85E0677');
        $this->addSql('CREATE TEMPORARY TABLE __temp__wuser AS SELECT id, username, roles, password, gender, email FROM wuser');
        ...
        $this->addSql('INSERT INTO wuser (id, username, roles, password, gender, email) SELECT id, username, roles, password, gender, email FROM __temp__wuser');
        $this->addSql('DROP TABLE __temp__wuser');
