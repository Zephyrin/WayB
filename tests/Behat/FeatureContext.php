...
final class FeatureContext implements Context
{
    ...
    public function thereAreDefaultUsers()
    {
        ...
        $this->iLogout();
        $this->createUser("admin", "admin_admin", "admin@en_equilibre.com");
        $this->iLogout();
        $this->iAmLoginAs("superadmin");
        ...
        $this->iLogout();
        $this->createUser("ambassador", "ambassador_ambassador", "ambassador@en_equilibre.com");
        $this->iLogout();
        $this->iAmLoginAs("superadmin");
        $this->apiContext->setRequestBody(
            "{\"roles\": [\"ROLE_AMBASSADOR\"]}"
        );
        $this->apiContext->requestPath("/api/en/user/ambassador", 'PATCH');
        $this->iLogout();
